...
try:
    from identification.logger import setup_logging
    from identification.utils import read_json, write_json
except ImportError:
    from src.identification.logger import setup_logging
    from src.identification.utils import read_json, write_json
class ConfigParser:
