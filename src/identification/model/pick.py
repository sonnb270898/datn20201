...
try:
    ...
    from src.identification.model.encoder import Encoder
    from src.identification.model.graph import GLCN
    from src.identification.model.decoder import Decoder
